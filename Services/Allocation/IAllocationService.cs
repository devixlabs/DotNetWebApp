...
/// <summary>
/// Allocation service interface for inventory allocation operations.
...
public interface IAllocationService
{
    ...
    /// </summary>
    Task<IEnumerable<AllocationOrderSummary>> GetOrdersForAllocationAsync(
        int warehouseId,
    ...
    /// </summary>
    Task<AllocationOrderSummary?> GetOrderDetailAsync(string orderNumber, int warehouseId);

    /// <summary>
    /// Get line items for order with allocation status.
    /// </summary>
    Task<IEnumerable<AllocationLineItem>> GetOrderLineItemsAsync(string orderNumber, int warehouseId);
    ...
    /// </summary>
    Task<AllocationResult> AllocateOrderAsync(
        string orderNumber,
        string username,
        int warehouseId);
    ...
    /// </summary>
    Task<AllocationResult> AllocateLineItemAsync(
        string orderNumber,
        string productCode,
        decimal quantity,
        string username,
    ...
    /// </summary>
    Task<AllocationStatus> GetOrderStatusAsync(string orderNumber, int warehouseId);
