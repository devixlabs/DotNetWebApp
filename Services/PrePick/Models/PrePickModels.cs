namespace DotNetWebApp.Services.PrePick.Models;

/// <summary>
/// Represents a PrePick order with picker, auditor, and assembler assignments.
/// </summary>
public class PrePickOrder
{
...
/// <summary>
/// Summary view of a PrePick order for list display.
/// </summary>
public class PrePickOrderSummary
{
    public string OrderNumber { get; set; } = string.Empty;
    public DateTime? DueShipDate { get; set; }
    public string CarrierName { get; set; } = string.Empty;
