...
/// <summary>
/// Service interface for DMS (Dock Management System) operations
...
public interface IDMSService
{
    ...
    Task<IEnumerable<DMSOrder>> ListOrdersAsync(int warehouseId, DateTime date, string? statusFilter = null);
    ...
    Task<DMSOrder?> GetOrderAsync(long orderNumber, int warehouseId);
