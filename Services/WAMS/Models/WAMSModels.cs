namespace DotNetWebApp.Services.WAMS.Models;

/// <summary>
/// Order type classification for WAMS
...
public enum OrderType
{
    ...
    PO = 2,              // Purchase Order
    ICT_NYC = 3,             // ICT NYC
    ICT_Chicago = 4,         // ICT Chicago
    Deleted_SO = 11,         // Deleted Sales Order (1 + 10)
    Deleted_PO = 12,         // Deleted Purchase Order (2 + 10)
    Deleted_ICT_NYC = 13,    // Deleted ICT NYC (3 + 10)
    Deleted_ICT_Chicago = 14 // Deleted ICT Chicago (4 + 10)
}
...
/// <summary>
/// Complete WAMS order with all 39 properties from webapp_scheduler table
/// Maps to gs_* columns in WEBAPPMisc.dbo.webapp_scheduler
/// </summary>
public class WAMSOrder
{
    ...
    public long? OrderTypeValue { get; set; }    // gs_num1 (1=SO, 2=PO, 3=ICT_NYC, 4=ICT_Chicago, 11-14=Deleted)
...
/// Filtered by warehouse (d2_d1id=687 for Chicago users)
/// </summary>
public class OperatorInfo
{
    public string Username { get; set; } = string.Empty;
    public string FullName { get; set; } = string.Empty;
    public bool IsChicagoUser { get; set; }
}
