...
public class InventoryAllocationController : ControllerBase
{
    ...
    private readonly ILogger<InventoryAllocationController> _logger;

    public InventoryAllocationController(
        IInventoryAllocationService inventoryAllocationService,
        ILockService lockService,
        ILogger<InventoryAllocationController> logger)
    {
    ...
    /// </summary>
    [HttpGet("orders")]
    public async Task<ActionResult<IEnumerable<InventoryAllocationOrderSummary>>> GetOrders(
    ...
    public async Task<ActionResult<InventoryAllocationOrderSummary>> GetOrder(
        string orderNumber,
        [FromQuery] int warehouseId = 3)
    {
    ...
    public async Task<ActionResult<IEnumerable<InventoryAllocationLineItem>>> GetOrderLines(
        string orderNumber,
        [FromQuery] int warehouseId = 3)
    {
    ...
    public async Task<ActionResult<InventoryAllocationResult>> AllocateOrder(
        string orderNumber,
    ...
    public async Task<ActionResult<InventoryAllocationResult>> AllocateLineItem(
        string orderNumber,
        string productCode,
        [FromBody] AllocateOrderRequest request,
    ...
    public async Task<ActionResult<InventoryAllocationStatus>> GetOrderStatus(
        string orderNumber,
        [FromQuery] int warehouseId = 3)
    {
