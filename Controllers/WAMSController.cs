...
public class WAMSController : ControllerBase
{
    ...
    private readonly ILogger<WAMSController> _logger;

    public WAMSController(
        IWAMSService wamsService,
        ILogger<WAMSController> logger)
    {
    ...
    [HttpGet("orders")]
    [ProducesResponseType(typeof(IEnumerable<WAMSOrder>), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public async Task<ActionResult<IEnumerable<WAMSOrder>>> ListOrders(
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public async Task<ActionResult<WAMSOrder>> GetOrder(
